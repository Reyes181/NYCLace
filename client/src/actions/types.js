...
export const REMOVE_CART_QTY_USER = "remove_cart_qty_user";
export const ADD_CART_QTY_USER = "add_cart_qty_user";
...
export const GET_FOOTWEARS = 'get_footwears';
export const ADD_FOOTWEAR = 'add_footwear';
