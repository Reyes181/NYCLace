...
import converseBanner from '../../../Resources/banners/Converse.png';
...
class Converse extends Component {
    ...
    componentDidMount(){
        ...
        document.title = 'Converse - NYCLace';
    }
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${converseBanner})`}}></div>
                <div>
                    <PageTop
...
export default connect(mapStateToProps)(Converse);