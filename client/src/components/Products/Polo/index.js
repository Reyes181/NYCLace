...
import poloBanner from '../../../Resources/banners/Polo.png';
...
class Polo extends Component {
    ...
    componentDidMount(){
        ...
        document.title = 'Ralph Lauren Polo - NYCLace';
    }
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${poloBanner})`}}></div>
                <div>
                    <PageTop
                        title="Ralph Lauren Polo Brand"
                    />
...
export default connect(mapStateToProps)(Polo);