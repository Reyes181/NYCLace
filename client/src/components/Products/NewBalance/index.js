...
import newbalanceBanner from '../../../Resources/banners/New_Balance.png';
...
class NewBalance extends Component {
    ...
    componentDidMount(){
        ...
        document.title = 'New Balance - NYCLace';
    }
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${newbalanceBanner})`}}></div>
                <div>
                    <PageTop
