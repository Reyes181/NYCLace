...
import jordanBanner from '../../../Resources/banners/Jordan.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${jordanBanner})`}}></div>
                <div>
                    <PageTop
                        title="Jordan Brand"
                    />
...
export default connect(mapStateToProps)(Jordan);