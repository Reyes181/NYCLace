...
import nikeBanner from '../../../Resources/banners/Nike.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${nikeBanner})`}}></div>
                <div>
                    <PageTop
                        title="Nike Brand"
                    />
