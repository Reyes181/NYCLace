...
import pumaBanner from '../../../Resources/banners/Puma.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${pumaBanner})`}}></div>
                <div>
                    <PageTop
                        title="Puma Brand"
                    />
...
export default connect(mapStateToProps)(Puma);