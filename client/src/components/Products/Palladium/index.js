...
import palladiumBanner from '../../../Resources/banners/Palladium.png';
...
class Palladium extends Component {
    ...
    componentDidMount(){
        ...
        document.title = 'Palladium - NYCLace';
    }
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${palladiumBanner})`}}></div>
                <div>
                    <PageTop
                        title="Palladium Brand"
                    />
...
export default connect(mapStateToProps)(Palladium);