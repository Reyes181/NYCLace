...
import vansBanner from '../../../Resources/banners/Vans.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${vansBanner})`}}></div>
                <div>
                    <PageTop
                        title="Vans Brand"
                    />
...
export default connect(mapStateToProps)(Vans);