...
import adidasBanner from '../../../Resources/banners/adidas.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${adidasBanner})`}}></div>
                <div>
                    <PageTop
                        title="adidas Brand"
                    />
