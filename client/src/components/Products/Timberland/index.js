...
import timberlandBanner from '../../../Resources/banners/Timberland.png';
...
class Timberland extends Component {
    ...
    componentDidMount(){
        ...
        document.title = 'Timberland - NYCLace';
    }
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${timberlandBanner})`}}></div>
                <div>
                    <PageTop
                        title="Timberland Brand"
                    />
...
export default connect(mapStateToProps)(Timberland);