...
import asicsBanner from '../../../Resources/banners/Asics.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${asicsBanner})`}}></div>
                <div>
                    <PageTop
                        title="Asics Brand"
                    />
...
export default connect(mapStateToProps)(Asics);