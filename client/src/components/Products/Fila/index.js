...
import filaBanner from '../../../Resources/banners/Fila.png';
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${filaBanner})`}}></div>
                <div>
                    <PageTop
                        title="Fila Brand"
                    />
