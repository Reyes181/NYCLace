...
import mitchellnessBanner from '../../../Resources/banners/Mitchell&Ness.png';
...
class MitchellNess extends Component {
    ...
    componentDidMount(){
        ...
        document.title = 'Mitchell&Ness - NYCLace';
    }
    ...
    render() {
        ...
        return (
            <div className="brand_page">
                <div className="product_banner" style={{background:`url(${mitchellnessBanner})`}}></div>
                <div>
                    <PageTop
                        title="Mitchell&Ness Brand"
                    />
...
export default connect(mapStateToProps)(MitchellNess);