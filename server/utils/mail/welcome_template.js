                                    ...
                                    <tbody>
                                      ...
                                      <tr>
                                        <td align="center">
                                          ...
                                          width="75%">We are glad you signed up to be part of the NYCLace community. The door has been
                                                open for amazing deals on our mass amount of footwears and apperals.
                                            <br>
                                            <br>In the meantime, here are a few parts of NYCLace you might have missed:</p>
                                        </td>
                                      </tr>
                                    </tbody>
                                  </table>
                                      ...
                                      <tr>
                                        <td>
                                          ...
                                          target="_blank" data-hs-link-id="0">
                                            <img src="https://res.cloudinary.com/reyes181/image/upload/v1545967831/email_1.png"
                                ...
                                <td>
                                  ...
                                  width="93.75%">
                                    <tbody>
                                      <tr>
                                        <td align="center">
                                          <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:24px; color:#65648c; letter-spacing:0; line-height:32px; margin-top:23px; display:none">New Brand Added</h1>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center">
                                          <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; max-width:380px; margin-bottom:30px">Mitchell and Ness have been added to our selections of brands.
                                            Enjoy fine selection of throwback jerseys, shorts, and hats and more from Mitchell and Ness.</p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td>
                                          <a href="/"
                                          target="_blank" data-hs-link-id="0">
                                            <img src="https://res.cloudinary.com/reyes181/image/upload/v1545978552/email_2.png"
                                            width="738" style="width:100%;max-width:738px;display:block;">
                                          </a>
                                        </td>
                                      </tr>
                                ...
                                <td>
                                  ...
                                  width="93.75%">
                                    <tbody>
                                      <tr>
                                        <td align="center">
                                          <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:24px; color:#65648c; letter-spacing:0; line-height:32px; margin-top:23px; display:none">More Shoe Sizes</h1>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center">
                                          <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; max-width:380px; margin-bottom:30px">More footwear in sizes 11 - 13 have been added, and the near future more
                                            women sizes are to be added.</p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center">
                                    ...
                                    <tbody>
                                      <tr>
                                        <td>
                                          <a href="/"
                                          target="_blank" data-hs-link-id="0">
                                            <img src="https://res.cloudinary.com/reyes181/image/upload/v1545979350/email_3.png"
                                            width="738" style="width:100%;max-width:738px;display:block;">
                                          </a>
                                        </td>
                                      </tr>
                                ...
                                <td>
                                  ...
                                  width="93.75%">
                                    <tbody>
                                      <tr>
                                        <td align="center">
                                          <h1 style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; margin:0 auto; font-size:24px; color:#65648c; letter-spacing:0; line-height:32px; margin-top:23px; display:none">New Location</h1>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center">
                                          <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px; max-width:380px; margin-bottom:30px">We have moved to diffrent location, still in NYC.
                                            Our new address can been seen at the bottom of this email in the footer.</p>
                                        </td>
                                      </tr>
                                      <tr>
                                        <td align="center">
        ...
        <span class="card-cta" summary="card-cta" style="border-radius:35px;border:1px solid #65648c;background-color:#FFFFFF;padding:10px 44px 10px 44px;color:#65648c;display:inline-block;font-family: 'Aktiv Grotesk', BlinkMacSystemFont, Helvetica,Arial,sans-serif;font-weight: bold;font-size:10px;letter-spacing:1px;line-height:20px !important;text-transform:uppercase;text-align:center;text-decoration:none;-webkit-text-size-adjust:none;">VISIT SITE</span>
                          ...
                          width="84.375%">
                            <tbody>
                              ...
                              <tr>
                                <td align="center">
                                  <p style="margin-bottom: 1em; font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; font-size:16px; margin:0 auto; letter-spacing:0; line-height:32px">We hope you enjoy being a member of NYCLace, and look forward to sharing more exclusive
                          ...
                          width="93.75%">
                            <tbody>
                              ...
                              <tr>
                                <td align="center">
                                  <img src="https://res.cloudinary.com/reyes181/image/upload/v1535065365/reptile_nimble.png"
