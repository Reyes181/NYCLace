...
const resetPass = (data) => {
    ...
    'http://projects-reyes181.c9users.io:8080'
                                  ...
                                  <tr>
                                    <td>
                                      ...
                                      width="93.75%">
                                        <tbody>
                                          <tr>
                                            <td class="hello" align="center" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:bold; font-size:10px; color:#424659; letter-spacing:1px; text-transform:uppercase; border:30px solid #ffffff">Password Reset</td>
                                          </tr>
                                          <tr>
                                          ...
                                          <tr>
                                            <td align="left">
                                              <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; margin:0 auto; font-size:16px; color:#111111; letter-spacing:-0.5px; line-height:48px">This email was sent because a request was made to reset the password associated with this email account.</p>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td align="left">
                                              <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; margin:0 auto; font-size:16px; color:#111111; letter-spacing:-0.5px; line-height:48px">Click the link below to reset your password.</p>
                                            </td>
                                          </tr>
                                          <tr>
                                          <tr>
                                            <td align="left">
                                              <a href="${URL}/reset_password/${data.resetToken}" style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; margin:0 auto; font-size:16px; color:#111111; letter-spacing:-0.5px; line-height:48px">Reset Password </a>
                                            </td>
                                          </tr>
                                          <tr>
                                            <td height="25" style="font-size:0;line-height:0;height:25px;">&nbsp;</td>
                                          ...
                                          <tr>
                                            <td align="left">
                                              <p style="font-family:'Aktiv Grotesk', BlinkMacSystemFont, Helvetica, Arial, sans-serif; font-weight:normal; margin:0 auto; font-size:16px; color:#111111; letter-spacing:-0.5px; line-height:48px">Please disregard this email, if you did not make this request for a change of password.</p>
                                            </td>
                                          </tr>
                                        </tbody>
                                      </table>
